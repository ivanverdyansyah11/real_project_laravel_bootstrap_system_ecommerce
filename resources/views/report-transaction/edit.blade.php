...
@section('content-dashboard')
    <div class="row me-lg-4 pb-4 d-none d-md-inline-block" style="margin-top: 32px;">
        ...
        <div class="col-12 pe-lg-0">
            <form class="row" action="{{ route('transaction.update', $transactionId) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="col-12">
