                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input readonly type="text" class="form-control" id="day_limit"
                                        value="{{ Carbon\Carbon::parse($cart->updated_at)->addDay()->format('Y-m-d') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input readonly type="text" class="form-control" id="hour_limit"
                                        value="{{ Carbon\Carbon::parse($cart->updated_at)->format('H:i:s') }}">
                                </div>
                                <div class="col-md-6 mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    @php
                                        $shippingPrice =
                                            $transaction[0]->shipping == 'ekspedisi'
                                                ? ($transaction[0]->shipping_price != null
                                                    ? $transaction[0]->shipping_price
                                                    : '0')
                                                : '0';
                                    @endphp
                                    ...
                                    <input required type="number"
                                        ...
                                        min="{{ $cart->quantity * $totalProduct + $shippingPrice }}">
                                    @error('total_payment')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
