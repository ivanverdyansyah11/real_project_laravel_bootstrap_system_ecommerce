                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input readonly type="hidden" class="form-control" id="products_id" name="products_id[]" value="{{ $item->product->id }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input readonly type="text" class="form-control" id="selling_price" value="{{ $item->product->selling_price }}">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label for="quantity" class="form-label">Kuantitas Dibeli</label>
                                        <input required type="number" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity[]" value="{{ $item->quantity }}" min="1" max="{{ $item->product->stock }}">
                                        @error('quantity')
