...
@section('content-homepage')
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-4">
                <img src="{{ file_exists('assets/images/product/' . $product->image) && $product->image ? asset('assets/images/product/' . $product->image) : asset('assets/images/other/img-not-found.jpg') }}" class="card-img-top img-fluid rounded">
            </div>
            <div class="col-6">
                <div class="wrapper d-flex align-items-center justify-content-between mb-3">
                    <h5 class="title-product">{{ $product->name }}</h5>
                    <h6 class="title-price mt-3">Rp. {{ number_format($product->selling_price, 2, ",", ".") }}</h6>
                </div>
